<?php
// The $all_pemilik and $all_ras variables are passed from the addPet method in DashboardController
?>
<link rel="stylesheet" href="../../../../views/css/edit.css?v=1.1">
<div class="container">
    <h1>Add Pet</h1>
    <form action="/dashboard/pet/add" method="POST" class="edit-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="warna_tanda" name="warna_tanda" required>
        </div>
        <div class="form-group">
