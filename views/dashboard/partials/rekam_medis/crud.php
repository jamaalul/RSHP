...
<div class="container">
    ...
    <a href="/dashboard/rekam-medis/add" class="btn btn-primary mb-3">Tambah <?php  echo ucfirst($key); ?></a>
    <table class="table">
        <thead>
            <tr>
            ...
            <?php if (!empty($data)): ?>
                <?php foreach ($data as $row): ?>
                    <tr>
                        ...
                        <?php endforeach; ?>
                        <td>
                            <a href="/dashboard/rekam-medis/edit/<?php echo $row->id; ?>" class="btn btn-warning btn-sm">Edit</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
